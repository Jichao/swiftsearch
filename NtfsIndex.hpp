...
public:
	...
	typedef std::pair<SegmentNumber, std::pair<StandardInformationAttribute, std::pair<FileNameAttribute, DataAttribute::second_type> > > CombinedRecord;
	...
	virtual boost::iterator_range<TCHAR const *> get_name(FileNameAttribute::first_type const range) const = 0;
